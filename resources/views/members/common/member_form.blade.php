<tr>
	...
	<td>
		<input type="text" name="name" id="dlt_name" value="{{ MemberHelper::getOld('name') }}" class="pure-input-1">
		@if ($errors->has('name'))
...
<tr>
	...
	<td>
		<input type="text" name="kana" id="dlt_kana" value="{{ MemberHelper::getOld('kana') }}" class="pure-input-1">
		@if ($errors->has('kana'))
...
<tr>
	...
	<td>
	   <input type="text" name="email" id="dlt_email" value="{{ MemberHelper::getOld('email') }}" class="pure-input-1">
		@if ($errors->has('email'))
...
<tr>
	...
	<td>
	   <input type="text" name="email_confirmation" id="dlt_emailconf" value="{{ MemberHelper::getOld('email_confirmation') }}" class="pure-input-1">
...
<tr>
	...
	<td>
		<input type="text" name="telephone_no" id="dlt_phone" value="{{ MemberHelper::getOld('telephone_no') }}" class="pure-input-1">
...
<tr>
	...
	<td>
		<input type="text" name="birthday" id="dlt_birth" value="{{ MemberHelper::getOld('birthday') }}" class="pure-input-1">
...
<tr>
	...
	<td>
		<input type="password" name="password" id="dlt_password" class="pure-input-1">
